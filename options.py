...
def args_parser():
    ...
    parser.add_argument('--device', type=str, default='cuda:0', help='Training device, e.g., "cuda:x", or "cpu".')
    ...
    parser.add_argument('--model_family', type=str, default='HtFE4', choices=['HtFE4', 'HtFE6', 'HtC4', 'HtFE4-HtC2'], help='Heterogeneous model family configuration.')
    ...
    parser.add_argument('--noise_add', type=str,  default='vpp',  help='Prototype noise mechanism.')
    ...
    parser.add_argument('--vpp_score_clip_max', type=float, default=0.1, help='Clip max for VPP score calculation.')
